...
class GarmentsControllerTest < ActionController::TestCase
  ...
  test "should create garment" do
    assert_difference('Garment.count') do
      post :create, garment: { collection_id: @garment.collection_id, description: @garment.description, kind: @garment.kind, name: @garment.name, price: @garment.price, size_id: @garment.size_id }
    end
  ...
  test "should update garment" do
    patch :update, id: @garment, garment: { collection_id: @garment.collection_id, description: @garment.description, kind: @garment.kind, name: @garment.name, price: @garment.price, size_id: @garment.size_id }
    assert_redirected_to garment_path(assigns(:garment))
  end
